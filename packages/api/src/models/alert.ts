...
export type AlertTypeDb = 'rate_limit' | 'token_failure' | 'usage_exceeded' | 'session_waste' | '7d_risk'
...
const alertSchema = new Schema<IAlert>(
  {
    ...
    type: { type: String, required: true, enum: ['rate_limit', 'token_failure', 'usage_exceeded', 'session_waste', '7d_risk'] },
